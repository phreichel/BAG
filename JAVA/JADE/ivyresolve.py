...
IVY_BIN_DIR = "ivy-bin"  # Verzeichnis, in dem wir die Ivy JAR ablegen wollen
CACHE_DIR = "ivy-cache"  # Dein lokales Ivy-Cache-Verzeichnis
LIB_DIR = "lib"  # Ziel-Verzeichnis fuer Abhaengigkeiten

IVY_SETTINGS_FILE = "ivysettings.xml"  # Dein Ivy-Einstellungs-XML
IVY_FILE = "ivy.xml"  # Dein Ivy-Abhaengigkeits-XML
