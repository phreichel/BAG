	...
	c(0,0,1) {
		difference() {
			union() {
				tz(20) cyl(4,R-2*r);
				difference() {
					t(-23.5,-23.5,0) box(47,47,24);
					t(-21.5,-21.5,-.1) box(43,43,20.1);
					t(-11,-26,-.1) box(22,52,24.2);
					t(-26,-11,-.1) box(52,22,24.2);
				}
				t(+24,+24,0) cyl(24,3);
				t(+24,-24,0) cyl(24,3);
				t(-24,+24,0) cyl(24,3);
...
module cycloid_assembly() {
	...
	tz(-4.5) col($GREEN_D) axis_cap(R,N,eF);
	tz(10) col($GREEN_D) axis_cap(R,N,eF);
	*/
	...
	tz(1) {	
		tx(R/N) {
			bearing();
			col($GREEN) cycloid_disk(R-.2,N,eF,h,10.5,7);
		}
		tz(h) rz(180) tx(R/N) {
			bearing();
			col($BLUE_L) cycloid_disk(R-.2,N,eF,h,10.5,7);
		}
	}
	...
	tz(-27) rz(-45) nema_adapter(R,N,h,7);
	*/
